 ...
 * @subpackage Singlesite_Anchors/admin/partials
 */
?>

<!-- This file should primarily consist of HTML with a little bit of PHP. -->
<?php
$plugin_name    = 'Singlesite Anchors settings';
$link_get_param = '';
...
<div class="mas-plugin-wrapper">
    ...
    <div class="mas-plugin-content">
        ...
        <form class="form-inline w-50 mb-2">
            <div class="form-group mb-2">
                <label for="inputPattern" class="sr-only">Link pattern</label>
                <input type="text" class="form-control" id="inputPattern" value="<?php echo $link_get_param; ?>"
                       placeholder="Link pattern: like google.com">
            </div>
			...
			foreach ( $my_posts as $post ) :
				...
				if ( $matches ) :
                    ...
                    <li class="mas-plugin-website__post">
                        <h4 class="mas-plugin-website__post-title"><?php esc_html_e( 'Post: ' );
							...
							<?php foreach ( $matches as $match ) :
                                ...
                                <li class="mas-plugin-website__post-link-info">
                                    <form class="form-group mas-plugin-form">
                                        ...
                                        <input type='text' class="form-control" id='current-anchor'
                                               name='current-anchor' value='<?php echo $anchor; ?>' readonly>
                                        <label for='link'>Link:</label>
                                        <input type='text' class="form-control" id='link' name='link'
                                               value='<?php echo $link; ?>' readonly>
                                        <label for='new-anchor'>New Anchor</label>
                                        <input type='text' class="form-control" id='new-anchor' name='new-anchor'
                                               value=''>
